# Copy From : https://gist.github.com/buzzySmile/d46f537a810a7d97efc7
...
protobuf_decl.commands = ../../../ThirdParty/protobuf/bin/protoc --cpp_out=${QMAKE_FILE_IN_PATH} --proto_path=${QMAKE_FILE_IN_PATH} ${QMAKE_FILE_NAME}
