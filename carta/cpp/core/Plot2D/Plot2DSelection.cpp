#include "Plot2D/Plot2DSelection.h"
#include <QPainter>
#include <QDebug>
#include <qwt_plot.h>
...
Plot2DSelection::Plot2DSelection():
...
double Plot2DSelection::getClipMax() const {
    return m_clipMax;
}

double Plot2DSelection::getClipMin() const {
    return m_clipMin;
}
...
int Plot2DSelection::getUpperBound() const {
...
void Plot2DSelection::setClipValues( double minX, double maxX ){
    m_clipMin = minX;
    m_clipMax = maxX;
}


void Plot2DSelection::setColoredShade( QColor color ){
    m_shadeColor = color;
}

void Plot2DSelection::setHeight( int h ){
	m_height = h;
}

void Plot2DSelection::setBoundaryValues( double minX, double maxX ){
	m_lowerBound = minX;
	m_upperBound = maxX;
}


void Plot2DSelection::setSelectionMode(bool selection){
