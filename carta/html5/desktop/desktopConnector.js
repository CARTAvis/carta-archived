...
(function () {
    ...
    View.prototype.mouseMoveCB = function mouseMoveCB(ev) {
        ...
        if (this.MouseMoveDelay < 0) {
            ...
            if (!this.m_mousePosSlotScheduled) {
                ...
                this.m_mouseMoveTimeoutHandle = window.setTimeout(this.mouseMoveTimeoutCB.bind(this), this.MouseMoveDelay);
            } else {
    ...
    connector.connect = function () {
        ...
        if (window.QtConnector !== undefined && m_connectionStatus != connector.CONNECTION_STATUS.CONNECTED ) {
            ...
            console.log("connector.connect is not ready, so no invoke callback");
        }
    };
