/**
 * Command to show/hide the statistics settings.
 */
/*global mImport */
/*******************************************************************************
 * @ignore( mImport)
...
qx.Class.define("skel.Command.Settings.SettingsStatistics", {
    ...
    construct : function( ) {
        ...
        this.base( arguments, "Statistics Settings", cmd);
        this.setToolTipText( "Show/hide statistics settings.");
        this.m_global = false;
    ...
    members : {
        ...
        /**
         * Update the visibility of the statistics settings based on server state.
