...
qx.Class.define("skel.Command.Layout.CommandLayoutDefault", {
    ...
    construct : function() {
        ...
        var cmd = path.SEP_COMMAND + "setDefaultLayout";
        this.base( arguments, "Default Layout", cmd);
        this.m_toolBarVisible = false;
        this.setValue( false );
        this.setToolTipText("Set a predefined layout.");
    },
