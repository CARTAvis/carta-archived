...
qx.Class.define("skel.Command.CommandAll", {
    ...
    construct : function( ) {
        ...
        //First the globals
        this.m_cmds[0] = skel.Command.Data.CommandData.getInstance();
        this.m_cmds[1] = skel.Command.Session.CommandSession.getInstance();
        this.m_cmds[2] = skel.Command.Layout.CommandLayout.getInstance();
        this.m_cmds[3] = skel.Command.Preferences.CommandPreferences.getInstance();

        //Now the window specific ordered from most popular to least supported.
        this.m_cmds[4] = skel.Command.View.CommandViews.getInstance();
        this.m_cmds[5] = skel.Command.Link.CommandLink.getInstance();
        this.m_cmds[6] = skel.Command.Window.CommandWindow.getInstance();
        this.m_cmds[7] = skel.Command.Clip.CommandClip.getInstance();
        var index = 8;
