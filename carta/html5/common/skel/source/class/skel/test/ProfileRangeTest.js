qx.Class.define("skel.test.ProfileRangeTest", {
    ...
    members : {
        ...
        setUp : function() {
            this.m_rangeWidget = new skel.widgets.Profile.SettingsZoom();
        },
        ...
        testPercentMax : function(){
        	this.m_rangeWidget.setZoomPercents( 0.5, 150 );
        	this.assertTrue( this.m_rangeWidget.m_percentMaxClipText._isWarning());
        	this.m_rangeWidget.setZoomPercents( 0.5, 0.9 );
        ...
        testPercentMin : function(){
        	this.m_rangeWidget.setZoomPercents( -0.5, 50 );
        	this.assertTrue( this.m_rangeWidget.m_percentMinClipText._isWarning());
        	this.m_rangeWidget.setZoomPercents( 0.5, 90 );
