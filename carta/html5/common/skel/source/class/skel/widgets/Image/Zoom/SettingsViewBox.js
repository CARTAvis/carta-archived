/**
 * Controls for customizing the pixel box in the zoom view.
 */
/*global mImport */
/*******************************************************************************
 * @ignore( mImport)
...
qx.Class.define("skel.widgets.Image.Zoom.SettingsViewBox", {
    ...
    members : {
        ...
        _init : function( ) {
            ...
            this.m_contextSettings = new skel.widgets.Image.Zoom.SettingsContext();
            this.m_content.add( this.m_contextSettings );
        },
      

        /**
         * Update the UI based on server-side pixel box settings.
         * @param controls {Object} - server side pixel box settings.
         */
