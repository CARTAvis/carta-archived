...
qx.Class.define("skel.widgets.Grid.GridPage.GridPageAxes", {
    ...
    members : {
        ...
        _makeColorPage : function(){
            this.m_colorPage = new skel.widgets.Grid.Color.ColorPage("setAxesColor");
        },
        ...
        _makeSettingsPage : function(){
            this.m_settingsPage = new skel.widgets.Grid.Settings.SettingsAxesPage();
        },
