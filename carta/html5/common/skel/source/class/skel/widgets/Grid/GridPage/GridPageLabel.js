...
qx.Class.define("skel.widgets.Grid.GridPage.GridPageLabel", {
    ...
    members : {
        ...
        _makeColorPage : function(){
            this.m_colorPage = new skel.widgets.Grid.Color.ColorPage("setLabelColor");
        },
        ...
        _makeSettingsPage : function(){
            this.m_settingsPage = new skel.widgets.Grid.Settings.SettingsLabelPage();
        },
