...
qx.Class.define("skel.widgets.Grid.GridPage.GridPageCanvas", {
    ...
    members : {
        ...
        _makeColorPage : function(){
            this.m_colorPage = new skel.widgets.Grid.Color.ColorThemePage();
        },
        ...
        _makeSettingsPage : function(){
            this.m_settingsPage = new skel.widgets.Grid.Settings.SettingsCanvasPage();
        },
