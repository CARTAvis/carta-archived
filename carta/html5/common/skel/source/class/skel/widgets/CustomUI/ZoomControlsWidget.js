/**
 * Controls for setting the zoom for a plot, either as a [min,max] range
 * or as a percentage.
 */
/*global mImport */
/*******************************************************************************
...
qx.Class.define("skel.widgets.CustomUI.ZoomControlsWidget", {
    extend : qx.ui.core.Widget,

    construct : function( appBase ) {
        this.base(arguments);
        this._init( appBase );
    ...
    members : {
        ...
        /**
         * Callback for a server error when setting the plot minimum clip value.
        ...
        /**
         * Callback for a server error when setting the plot maximum clip value.
         * @return {function} which displays/clears the error.
         */
        ...
        /**
         * Callback for a server error when setting the plot minimum clip percent.
         * @return {function} which displays/clears the error.
         */
        ...
        /**
         * Callback for a server error when setting the plot maximum clip percent.
         * @return {function} which displays/clears the error.
         */
        ...
        _init : function( appBase ) {
            ...
            this.m_minClipText.setTextId( appBase + "ZoomMinValue");
            ...
            this.m_percentMinClipText.setTextId( appBase + "ZoomMinPercent");
            ...
            this.m_maxClipText.setTextId( appBase + "ZoomMaxValue");
            ...
            this.m_percentMaxClipText.setTextId( appBase + "ZoomMaxPercent");
            ...
            this.m_buffer.addListener( skel.widgets.Path.CHANGE_VALUE, function(e){
                ...
                if ( this.m_connector !== null ){
                    ...
                    console.log("grimmer-his2:",cmd);
                    console.log("grimmer-his2-2:",params);
            ...
            this.m_fullRange.setToolTipText( "Zoom out to full range.");
            this.m_fullRange.addListener( "execute", function(){
                var path = skel.widgets.Path.getInstance();
                var cmd = this.m_id + path.SEP_COMMAND + skel.widgets.CustomUI.ZoomControlsWidget.CMD_ZOOM_FULL;
                var params = "";
                this.m_connector.sendCommand( cmd, params, function(){});
            }, this );
            ...
            this.m_selectedRange.addListener( "execute", function(){
                var path = skel.widgets.Path.getInstance();
                var cmd = this.m_id + path.SEP_COMMAND + skel.widgets.CustomUI.ZoomControlsWidget.CMD_ZOOM_RANGE;
                var params = "";
                this.m_connector.sendCommand( cmd, params, function(){});
            }, this );
        ...
        _sendClipMinCmd: function(){
            if( this.m_connector !== null ){
                ...
                if( !isNaN(minClip) ){
                    var path = skel.widgets.Path.getInstance();
                    var cmd = this.m_id+path.SEP_COMMAND+skel.widgets.CustomUI.ZoomControlsWidget.CMD_SET_CLIP_MIN;
        ...
        _sendClipMaxCmd: function(){
            if( this.m_connector !== null ){
                ...
                if( !isNaN(maxClip) ){
                    var path = skel.widgets.Path.getInstance();
                    var cmd = this.m_id+path.SEP_COMMAND+skel.widgets.CustomUI.ZoomControlsWidget.CMD_SET_CLIP_MAX;
         ...
         _sendClipMinPercentCmd: function(){
             if( this.m_connector !== null ){
                 ...
                 if( !isNaN(minPercentClip) ){
                     var path = skel.widgets.Path.getInstance();
                     var cmd = this.m_id+path.SEP_COMMAND+skel.widgets.CustomUI.ZoomControlsWidget.CMD_SET_CLIP_MIN_PERCENT;
         ...
         _sendClipMaxPercentCmd: function(){
             if( this.m_connector !== null ){
                 ...
                 if( !isNaN(maxPercentClip) ){
                     var path = skel.widgets.Path.getInstance();
                     var cmd = this.m_id+path.SEP_COMMAND+skel.widgets.CustomUI.ZoomControlsWidget.CMD_SET_CLIP_MAX_PERCENT;
        ...
        /**
         * Set upper and lower bounds for the plot range.
