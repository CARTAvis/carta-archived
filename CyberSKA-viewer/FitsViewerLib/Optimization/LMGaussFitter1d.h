#ifndef LMGAUSSFITTER1D_H
#define LMGAUSSFITTER1D_H
...
public:
    ...
    LMFitter( DataInterface & dataInterface)
        : di( dataInterface)
    {
        firstTime = true;
    }
...
//    double getChiSq() { return levmar.chiSq(); }
    ...
    void constraintParameters( double * params) {
        di.constraintParameters( params);
    }
...
std::vector<double> LMFitter::getResults()
{
    ...
    if( ! x) throw std::runtime_error("GaussFitter1d::getResults: x = null");
