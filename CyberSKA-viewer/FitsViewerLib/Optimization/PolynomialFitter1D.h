#ifndef POLYNOMIALFITTER1D_H
#define POLYNOMIALFITTER1D_H
...
public:
    ...
    VD fit( int nTerms, const std::vector<Pair> & data);
...
public:
    ...
    void setAlgorithm( Algorithm which) { m_algorithm = which; }

    /// do an iteration
    bool iterate();

    /// get the results
    const VD & getResults() const { return m_results; }
...
protected:
    ...
    bool runCaruana();
    bool runNonIterativeGuo();
    bool runIterativeGuo();
