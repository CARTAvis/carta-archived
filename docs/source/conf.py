# -*- coding: utf-8 -*-
#
# CARTA Viewer documentation build configuration file, created by
# sphinx-quickstart on Thu Nov 26 11:10:29 2015.
#
...
project = u'CARTA Viewer'
copyright = u'2015, CARTA Team'
author = u'CARTA Team'
...
htmlhelp_basename = 'CARTAViewerdoc'
...
latex_documents = [
  (master_doc, 'CARTAViewer.tex', u'CARTA Viewer Documentation',
   u'CARTA Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'cartaviewer', u'CARTA Viewer Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'CARTAViewer', u'CARTA Viewer Documentation',
   author, 'CARTAViewer', 'One line description of project.',
   'Miscellaneous'),
]
