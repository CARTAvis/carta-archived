...
qx.Class.define("skel.Command.Colormap.Colormap", {
    ...
    construct : function() {
        ...
        this.m_cmds = [];
        this.m_cmds.push( skel.Command.Colormap.Settings.getInstance());
        this.m_cmds.push( skel.Command.Colormap.Preferences.getInstance());
