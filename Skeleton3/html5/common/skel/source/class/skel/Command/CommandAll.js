...
qx.Class.define("skel.Command.CommandAll", {
    ...
    construct : function( ) {
        ...
        this.m_cmds[8] = skel.Command.Grid.GridControls.getInstance();
        this.m_cmds[9] = skel.Command.Popup.CommandPopup.getInstance();
        this.m_cmds[10] = skel.Command.Animate.CommandAnimations.getInstance();
        this.m_cmds[11] = skel.Command.Histogram.Histogram.getInstance();
        this.m_cmds[12] = skel.Command.Colormap.Colormap.getInstance();
