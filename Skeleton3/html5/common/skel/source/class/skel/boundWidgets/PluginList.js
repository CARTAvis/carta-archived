        ...
        members: {
            ...
            _sharedVarCB: function( val) {
                ...
                for( var i = 0 ; i < val ; i ++ ) {
                    ...
                    var type = this.m_connector.getSharedVar( base + "type/"+pIndex ).get();
                    var version = this.m_connector.getSharedVar( base + "version/"+pIndex ).get();
                    var errors = this.m_connector.getSharedVar( base + "errors/" +pIndex).get();
                    var loaded = (errors === "");
