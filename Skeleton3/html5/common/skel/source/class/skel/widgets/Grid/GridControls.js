...
qx.Class.define("skel.widgets.Grid.GridControls", {
    ...
    members : {
        ...
        _init : function( ) {
            ...
            this.m_canvas = new skel.widgets.Grid.GridPage.GridPageCanvas();
            this.m_grid = new skel.widgets.Grid.GridPage.GridPageGrid();
            this.m_axes = new skel.widgets.Grid.GridPage.GridPageAxes();
            this.m_labels = new skel.widgets.Grid.GridPage.GridPageLabel();
            this.m_ticks = new skel.widgets.Grid.GridPage.GridPageTicks();
