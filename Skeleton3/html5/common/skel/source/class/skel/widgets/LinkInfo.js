/**
 * Encapsulation of link information for a window with regard to a source window.
 */
...
qx.Class.define("skel.widgets.LinkInfo",
 {
   ...
   members:{
	 ...
	 winId : "",
	 //Whether or not a bidirectional link is supported ( from this window to source )
	 twoWay : false
