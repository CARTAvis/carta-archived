...
qx.Class.define("skel.widgets.CustomLayoutPopup",
    {
        ...
        construct: function (  ) {
            ...
            this.add( rowLabel, {row:0, column:0});
            this.add( this.m_rowCountSpin, {row:0, column:1});
            this.add( colLabel, {row:1, column:0});
            this.add( this.m_colCountSpin, {row:1, column:1});
        },
