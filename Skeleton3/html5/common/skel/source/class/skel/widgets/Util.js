...
qx.Class.define("skel.widgets.Util",
 {
   ...
   statics:
   {
      ...
      getRight : function( widget ){
       ...
       /**
        * Returns an array of size 2 representing the point that is located at that center of the widget.
        * @param widget {qx.ui.core.Widget} the widget whose center is to be determined.
        */
       ...
       /**
        * Returns mouse event's local position (with respect to the event target)
        */
