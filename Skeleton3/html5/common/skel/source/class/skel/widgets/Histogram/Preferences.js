/**
 * Displays preferences for the histogram and allows users to set them.
 */
...
qx.Class.define("skel.widgets.Histogram.Preferences", {
    ...
    events : {
        "closeHistogramPreferences" : "qx.event.type.Data"
    },
    ...
    members : {
        ...
        _init: function(){
            ...
            var title = new qx.ui.basic.Label( "Histogram Preferences");
            ...
            this.m_closeButton.addListener( "execute", function(){
                this.fireDataEvent( "closeHistogramPreferences", null );
            }, this );
