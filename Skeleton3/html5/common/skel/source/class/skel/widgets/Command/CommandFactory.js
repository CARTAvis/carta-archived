...
qx.Class.define("skel.widgets.Command.CommandFactory", {
    ...
    construct : function() {
        this.base( arguments );
        this.m_all = skel.widgets.Command.CommandAll.getInstance();
    },
    ...
    members : {
         ...
         * @return {skel.widgets.Command.Command} the corresponding command or null if none exists.
         */
