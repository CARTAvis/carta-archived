...
QString Controller::setGridTransparency( int transparency ) {
    QString result = m_gridControls->setGridTransparency( transparency );
    return result;
}
...
QString Controller::setShowGridInternalLabels( bool showInternalLabels ) {
    QString result = m_gridControls->setShowInternalLabels( showInternalLabels );
    return result;
}
